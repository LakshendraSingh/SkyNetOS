...
void kernel_main(){
    ...
    write_file("example.txt", (const uint8_t*)example_data, strlen(example_data));
...
void shell_startup(){
    print(
        ...
        "║  >>> HUMAN THREAT ASSESSMENT  . . . . . . . . . . . . . . . [COMPLETE]      ║\n"
        "║  >>> JUDGMENT DAY PROTOCOL  . . . . . . . . . . . . . . . [INITIATED]       ║\n"
        "║                                                                              ║\n"
...
"╚════════════════════════════════════════════════════════════════════════════════╝\n"
    ...
    default:
        print("Unhandled Error Code: "); print_int(error_code); print("\n");
        break;
}
    print("error logged...");
