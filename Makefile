...
FILES = ./build/kernel.asm.o ./build/kernel.o ./build/io.o ./build/shell.o ./build/security.o ./build/memory_management.o ./build/file_system.o ./build/string.o ./build/sha3.o ./build/scheduler.o ./build/vga.o ./build/gui.o
...
test:
	...
	gcc -O0 -I./src src/scheduler.c src/memory_management.c src/io.c tests/test_scheduler.c -o test_scheduler && ./test_scheduler
	gcc -O0 -I./src src/file_system.c src/memory_management.c tests/test_file_system.c -o test_file_system && ./test_file_system
	gcc -O0 -I./src src/memory_management.c tests/test_memory_management.c -o test_memory_management && ./test_memory_management
	gcc -O0 -I./src src/io.c tests/test_io.c -o test_io && ./test_io
	gcc -O0 -I./src src/file_system.c src/memory_management.c tests/test_directories.c -o test_directories && ./test_directories
	rm -f test_security test_scheduler test_file_system test_memory_management test_io test_directories

clean:
	rm -f ./bin/*.bin ./build/*.o test_security test_scheduler test_file_system test_memory_management test_io